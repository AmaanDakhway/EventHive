...
public class    SettingsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        @SuppressLint({"MissingInflatedId", "LocalSuppress"}) TextView name = view.findViewById(R.id.profileName);
        @SuppressLint({"MissingInflatedId", "LocalSuppress"}) TextView email = view.findViewById(R.id.profileEmail);
